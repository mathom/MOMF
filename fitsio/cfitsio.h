...
#define ftgacl_ELEMLEN_A ZTRINGV_NUM(FITS_FLEN_HDEFKWDS)
...
#define ftgbcl_ELEMLEN_A ZTRINGV_NUM(FITS_FLEN_HDEFKWDS)
...
#define ftghtb_ELEMLEN_A ZTRINGV_NUM(FITS_FLEN_KEYVAL)
