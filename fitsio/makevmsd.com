...
$ ! 
$    write sys$output "Building Alpha OpenVMS version of FITSIO with DFLOAT..."
$    set verify
$    fortran/float=D_float fitsfort.f
$    fortran/float=D_float fitsio.f
$    fortran/float=D_float fitsalphavms.f
$    cc vmsieee.c
