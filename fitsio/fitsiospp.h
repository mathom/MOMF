...
define	SZ_FTTYPE	24	# length of column name string
define	SZ_FTFORM	16	# len of col datatype and display format strings
define	SZ_FTUNIT	24	# length of column units string
