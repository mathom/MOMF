...
C       and are specific to the Language Systems Fortran compiler
C       (in particular, Version 3.3) on Macintosh PowerMac.
C------------------------------------------------------------------------------
...
C       simply call character writing routine:
        call ftpcbf(ounit,nbytes,%descr(array),status)
        end
C--------------------------------------------------------------------------
...
C       simply call character writing routine:
        call ftpcbo(ounit,gsize,ngroup,offset,%descr(array),status)
        end
C----------------------------------------------------------------------
...
C       simply call character reading routine:
        call ftgcbf(iunit,nbytes,%descr(array),status)
        end
C--------------------------------------------------------------------------
...
C       simply call character reading routine:
        call ftgcbo(iunit,gsize,ngroup,offset,%descr(array),status)
        end
C------------------------------------------------------------------------
